...
-- - pipeline_stage includes: extract -> validate -> scale_amounts -> summarize -> categorize -> embed
-- - Public transparency:
...
create table if not exists public.extraction_artifacts (
  ...
  artifact_type public.pipeline_stage not null, -- extract/validate/scale_amounts/summarize/categorize/embed
...
-- =============================================================================
-- Phase 26 - Embed Terminal Notifications for Published AIPs (2026-03-10)
-- Source migration: website/docs/sql/2026-03-10_notifications_aip_embed_terminal_status.sql
-- =============================================================================
begin;
...
commit;
-- =============================================================================
-- Phase 27 - Embed Notification Action URL Alignment (2026-03-10)
-- Source migration: website/docs/sql/2026-03-10_notifications_aip_embed_action_url_scoped.sql
-- =============================================================================
begin;

-- =============================================================================
-- Embed notification action-url alignment
-- - Follow-up patch for uploader terminal notifications on extraction_runs.
-- - Ensures embed terminal notifications link to scoped AIP detail pages:
--   * barangay: /barangay/aips/:aipId
--   * city: /city/aips/:aipId
--   * admin fallback: /admin/aip-monitoring
-- - Keeps extraction event run-scoped links unchanged.
-- =============================================================================
...
-- =============================================================================
-- Phase 28 - Realtime Publication Hardening (2026-03-10)
-- Source migration: website/docs/sql/2026-03-10_realtime_publication_extraction_notifications.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 29 - Account Delete Preflight Blockers (2026-03-20)
-- Source migration: website/docs/sql/2026-03-20_account_delete_preflight_blockers.sql
-- =============================================================================
...
-- =============================================================================
-- Phase 17 - BAC A01 access control hardening (April 2026)
-- =============================================================================
...
-- =============================================================================
-- Phase 30 - A05 Default Function Privileges Fail Closed (2026-04-03)
-- Source migration: supabase/migrations/20260403_a05_default_function_execute_fail_closed.sql
-- =============================================================================
