...
export default function LguTopbar({ name, roleLabel, accountProfile, onOpenSidebar }: Props) {
  ...
  return (
    <header className="w-full border-b border-slate-200 bg-white">
      <div className="flex h-14 items-center justify-between gap-3 px-3 sm:px-4 lg:h-16 lg:px-8">
        ...
        <div className="ml-auto flex min-w-0 items-center gap-2 sm:gap-3 lg:gap-4">
          <div className="hidden max-w-[11rem] text-right leading-tight sm:block">
          ...
          <NotificationsBell href={notificationsHref} className="h-9 w-9 sm:h-10 sm:w-10" />
        </div>
      </div>
